...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="home">Clothes</a>
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Clothing Shop</h1>
        <p class="lead text-muted mb-0">Prestige creates a brand with more than 10 years of providing quality products</p>
    </div>
</section>
<!--end of menu-->
